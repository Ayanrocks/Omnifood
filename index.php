...
<body>
    ...
    <section class="section-meals">
        <ul class="meals-show clearfix">
            <li>
                <figure class="meal-photo">
                    <img src="resources/img/1.jpg" alt="Korean bibimbap with egg and vegetable"></figure>
            </li>
            <li>
                <figure class="meal-photo">
        ...
        <ul class="meals-show clearfix">
            <li>
                <figure class="meal-photo">
                    <img src="resources/img/5.jpg" alt="Paleo beef steak with vegetables"></figure>
            </li>
            <li>
                <figure class="meal-photo">
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2 steps-box">
                ...
                <a href="#" class="btn-app"><img src="resources/img/app-store.png"> </a>
    ...
    <section class="section-cities" id="cities">
        ...
        <div class="row js-wp-3">
            <div class="col span-1-of-4 box">
                ...
                <div class="city-feature">
                    <i class="ion-star icon-small"></i> 60+ top chefs
                </div>
                <div class="city-feature">
            ...
            <div class="col span-1-of-4 box">
                ...
                <div class="city-feature">
                    <i class="ion-star icon-small"></i> 160+ top chefs
                </div>
                <div class="city-feature">
            ...
            <div class="col span-1-of-4 box">
                ...
                <div class="city-feature">
                    <i class="ion-star icon-small"></i> 110+ top chefs
                </div>
                <div class="city-feature">
            ...
            <div class="col span-1-of-4 box">
                ...
                <div class="city-feature">
                    <i class="ion-star icon-small"></i> 50+ top chefs
                </div>
                <div class="city-feature">
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <div class="plan-box js-wp-4">
                    ...
                    <div>
                        <ul>
                            <li><i class="icon-small ion-ios-checkmark-empty"></i>1 meal every day</li>
                            <li><i class="icon-small ion-ios-checkmark-empty"></i>Order 24/7</li>
                            <li><i class="icon-small ion-ios-checkmark-empty"></i>Access to newest creations</li>
                            <li><i class="icon-small ion-ios-checkmark-empty"></i>Free delivery</li>
                        </ul>
                    </div>
                    <div>
                        <a href="#" class="btn btn-full" id="but">Sign up now</a>
                    </div>
                </div>
            </div>
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li><i class="icon-small ion-ios-checkmark-empty"></i>1 meal 10 days/month</li>
                            <li><i class="icon-small ion-ios-checkmark-empty"></i>Order 24/7</li>
                            <li><i class="icon-small ion-ios-checkmark-empty"></i>Access to newest creations</li>
                            <li><i class="icon-small ion-ios-checkmark-empty"></i>Free delivery</li>
                        </ul>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li><i class="icon-small ion-ios-checkmark-empty"></i>1 meal</li>
                            <li><i class="icon-small ion-ios-checkmark-empty"></i>Order from 8 am to 12 pm</li>
